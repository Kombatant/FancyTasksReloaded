...
ConfigPage {
    ...
    Kirigami.FormLayout {
        ...
        Kirigami.InlineMessage {
            Layout.fillWidth: true
            visible: groupedTaskVisualization.currentIndex === 1 && !plasmoid.configuration.showToolTips
            type: Kirigami.MessageType.Warning
            text: i18n("Tooltips are disabled, so a textual list will be displayed instead.")
        }
